...
export const typography = {
  ...
  value: 'text-xs font-mono text-white',
  
  // Secondary data values
  valueSecondary: 'text-xs font-mono text-slate-300',
  
  // Success/positive values
  valuePositive: 'text-xs font-mono text-green-300',
  
  // Error/negative values
  valueNegative: 'text-xs font-mono text-red-300',
  
  // Warning values
  valueWarning: 'text-xs font-mono text-yellow-300',
  
  // Neutral values
  valueNeutral: 'text-xs font-mono text-blue-300',
...
export const specializedTypography = {
  ...
  // Percentage changes
  percentagePositive: 'text-xs font-mono text-green-300',
  percentageNegative: 'text-xs font-mono text-red-300',
  
  // Signal confidence
  confidenceHigh: 'text-xs font-mono text-green-300',
  confidenceMedium: 'text-xs font-mono text-yellow-300',
  confidenceLow: 'text-xs font-mono text-red-300',
